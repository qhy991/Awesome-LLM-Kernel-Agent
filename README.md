...
|![Star](https://img.shields.io/github/stars/AI9Stars/AutoTriton.svg?style=social&label=Star) <br>  [**AutoTriton: Automatic Triton Programming with Reinforcement Learning in LLMs**](https://arxiv.org/abs/2507.05687) <br> | arXiv | 2025.07 | [Github](https://github.com/AI9Stars/AutoTriton) [🤗 HuggingFace](https://huggingface.co/ai9stars/AutoTriton) | Triton, Finetuning, RL |
...
| [**KernelLLM: Making Kernel Development More Accessible**](https://huggingface.co/facebook/KernelLLM) <br> | HuggingFace | 2025.06 | [🤗 HuggingFace](https://huggingface.co/facebook/KernelLLM) | Triton, Finetuning, SFT |
...
| [**KernelBook: PyTorch to Triton Code Translation Dataset**](https://huggingface.co/datasets/GPUMODE/KernelBook) <br> | HuggingFace | 2025.05 | [🤗 HuggingFace](https://huggingface.co/datasets/GPUMODE/KernelBook) | Triton, Dataset, PyTorch to Triton |
| ![Star](https://img.shields.io/github/stars/thunlp/TritonBench.svg?style=social&label=Star) <br> [**TritonBench: Benchmarking Large Language Model Capabilities for Generating Triton Operators**](https://arxiv.org/abs/2502.14752) <br> | ICML | 2025.02 | [Github](https://github.com/thunlp/TritonBench) [🤗 HuggingFace](https://huggingface.co/collections/LiShangZ/tritonbench) | Triton (CUDA) |
